...
def after():
    ...
    global model, resnet, vocab, inv_vocab, modele
    ...
    incept = modele.predict(image).reshape(1,2048)
    ...
    while tqdm(count < 20):
        ...
        sampled_index = np.argmax(resnet.predict([incept, padded]))
